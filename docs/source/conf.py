# -*- coding: utf-8 -*-
#
# OpenDeep documentation build configuration file, created by
...
project = u'OpenDeep'
copyright = u'2015, Vitruvian Science'
...
try:
    ...
    try:
        # The full version, including alpha/beta/rc tags.
        release = pkg_resources.get_distribution('opendeep').version
        # The short X.Y version.
        version = '.'.join(release.split('.')[:2])
...
latex_documents = [
  ('index', 'OpenDeep.tex', u'OpenDeep Documentation',
   u'Vitruvian Science', 'manual'),
]
...
epub_title = u'OpenDeep'
epub_author = u'Vitruvian Science'
epub_publisher = u'Vitruvian Science'
epub_copyright = u'2015, Vitruvian Science'

# The basename for the epub file. It defaults to the project name.
#epub_basename = u'OpenDeep'
